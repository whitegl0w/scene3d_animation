...
namespace scene3d_animation
{
    public partial class Form1 : Form
    {
        ...
        {
            string fileName = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "piece_of_cake.obj");
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (e.KeyCode)
            {
                case Keys.D: m_angle += 3; break;
                case Keys.A: m_angle -= 3; break;
            }
            glControl1.Refresh();
        }
